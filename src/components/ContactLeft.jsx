    ...
    <div
      className={`space-y-6 rounded-2xl border border-white/10 ${
        theme === "dark"
          ...
          : theme === "light"
          ? "bg-base-200 shadow-sm border border-gray-200  text-black/90"
          : ""
      } p-2 sm:p-8 md:p-10 w-full max-w-lg mx-auto md:mx-0`}
    >
      ...
      <div className="flex items-center justify-between rounded-xl border border-white/10 bg-blue-500/10 p-3 hover:scale-105 transition duration-300">
        ...
        >
          ...
          <div>
            ...
            <p className=" text-xs sm:text-base">hasanreazul87@gmail.com</p>
          </div>
        </a>
      ...
      {/* Location */}
      <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-purple-500/15 px-3 py-2 hover:scale-105 transition duration-300">
        ...
        <div>
          <p className={`${
                theme === "dark"
                  ...
                  ? "text-black/90"
                  : ""
              } text-sm sm:text-base`}>Location</p>
          <p className="text-xs sm:text-base">Sherpur, Bogura, Bangladesh</p>
        </div>
      </div>
